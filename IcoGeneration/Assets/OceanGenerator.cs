...
public class OceanGenerator
{
    ...
    public static void CreateIco(GameObject gameObject, OceanSettings settings)
    {
        ...
        vertList.Add(new Vector3(-1f, t, 0f).normalized*settings.oceandepth);
        vertList.Add(new Vector3(1f, t, 0f).normalized * settings.oceandepth);
        vertList.Add(new Vector3(-1f, -t, 0f).normalized * settings.oceandepth);
        vertList.Add(new Vector3(1f, -t, 0f).normalized * settings.oceandepth);

        vertList.Add(new Vector3(0f, -1f, t).normalized * settings.oceandepth);
        vertList.Add(new Vector3(0f, 1f, t).normalized * settings.oceandepth);
        vertList.Add(new Vector3(0f, -1f, -t).normalized * settings.oceandepth);
        vertList.Add(new Vector3(0f, 1f, -t).normalized * settings.oceandepth);

        vertList.Add(new Vector3(t, 0f, -1f).normalized * settings.oceandepth);
        vertList.Add(new Vector3(t, 0f, 1f).normalized * settings.oceandepth);
        vertList.Add(new Vector3(-t, 0f, -1f).normalized * settings.oceandepth);
        vertList.Add(new Vector3(-t, 0f, 1f).normalized * settings.oceandepth);
        ...
        faces = SubdivideFaces(faces, settings.detailLevel, settings.oceandepth);
